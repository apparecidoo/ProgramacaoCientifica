...
public:
	...
	double monte_carlo_volume_error(std::function<double(double, double, double)>f, int attempts); // calculate monte carlo error for equation of three variable and receiving attempts number
